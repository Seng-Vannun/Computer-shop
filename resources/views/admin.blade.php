...
<div class="container content-wrapper">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        @if(\Illuminate\Support\Facades\Session::get('Good'))
            <div class="alert alert-success">
                {{\Illuminate\Support\Facades\Session::get('Good')}}
            </div>
        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <span style="color:red">@error('phone_name'){{$message}}@enderror
                            </div>
                            <div class="col">
                                ...
                                <span style="color:red">@error('price'){{$message}}@enderror
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <span style="color:red">@error('feature'){{$message}}@enderror
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
